...
| `firstName` | `string` | ✅ | Только буквы (A-Za-z, А-Яа-яЁё, дефис, пробел) | `"Иван"` |
...
|---|---|---|---|---|
| `accountType` | `string` (enum) | ✅ | `CHECKING`, `SAVED`, `DEPOSIT` | `"CHECKING"` |
...
{
  "id": 1,
  "accountNumber": "40817810099001234567",
  "accountType": "CHECKING",
  "currency": "RUB",
  "balance": 0.00,
  "status": "ACTIVE"
...
[
  ...
  {
    "id": 2,
    "accountNumber": "40817840099009876543",
    "accountType": "SAVED",
    "currency": "USD",
    "balance": 500.00,
    "status": "ACTIVE"
...
| `cardType` | `string` (enum) | ✅ | `DEBIT`, `CREDIT` | `"DEBIT"` |
| `paymentSystem` | `string` (enum) | ✅ | `VISA`, `MASTERCARD`, `MIR` | `"VISA"` |
...
| Поле | Тип | Обязательно | Валидация | Пример |
|---|---|---|---|---|
| `fromAccountId` | `integer` | ✅ | ID вашего счёта | `1` |
| `toAccountId` | `string` | ✅ | Номер счёта получателя | `"40817810099009876543"` |
...
{
  "fromAccountId": 1,
  "toAccountId": "40817810099009876543",
  "amount": 1500.00,
  "description": "За обед"
}
```
...
| Поле | Тип | Обязательно | Валидация | Пример |
|---|---|---|---|---|
| `oldPassword` | `string` | ✅ | Не пустой | `"OldPass123"` |
| `newPassword` | `string` | ✅ | 8–128 символов | `"NewSecurePass456"` |
| `repeatNewPassword` | `string` | ✅ | Должен совпадать с `newPassword` | `"NewSecurePass456"` |
...
```json
{
  ...
  "repeatNewPassword": "NewSecurePass456"
}
```
